/* JavaScript functions voor index.html */

// function hi(){
//     var name = document.getElementById('yourName').value;
//     document.getElementsByTagName('h1')[0].innerHTML = "Hi " + name;
// }
// function bye(){
//     var name = document.getElementById('yourName').value;
//     document.getElementsByTagName('h1')[0].innerHTML = "Bye " + name;
// }
// function goodbye(){
//     var name = document.getElementById('yourName').value;
//     document.getElementsByTagName('h1')[0].innerHTML = "Goodbye " + name;
// }
